$(function () {
    ...
    //Clears the score and move count, erases the board, and makes it X's turn.
    ...
    /*Sets the clicked-on square to the current player's mark,
      then checks for a win or end game.  Also changes the current player.*/
    set = function () {
    ...
    /*Creates and attaches the DOM elements for the board as an HTML table,
      assigns the indicators for each cell, and starts a new game.*/
    play = function () {
